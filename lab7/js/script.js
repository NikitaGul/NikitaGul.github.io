...
//secondElement.style.verticalAlign = "middle";
...
secondElement.onclick = () => 
{
	...
	{
		secondElement.innerHTML = "No" + result;
	}
	if(result >= 0.5 && inputElement.value != 0)
	{
		secondElement.innerHTML = "Yes" + result;
	}
}	
